...
import { LanguageTranslatorButton } from "@/components/google-translate"
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            {/* Translator at the end of nav — no overlap possible */}
            <LanguageTranslatorButton />
          </nav>

          {/* Mobile: translator + hamburger side by side */}
                ...
                <div className="flex flex-col space-y-6 mt-8">
                  {navigation.map((item) => {
                    ...
                    return isTranslated() ? (
                      ...
                      >
                        {isActive && (
                          <span className="w-1 h-6 bg-accent rounded-full mr-2" />
                        )}
                        {item.name}
                      </a>
                    ) : (
