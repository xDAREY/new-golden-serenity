          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="bg-white border border-primary/20 p-6 rounded-xl shadow-sm">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 space-y-6 border border-slate-100">
                <h3 className="text-xl font-bold text-slate-800">How It Differs from Standard Medicaid</h3>
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">(e.g., tracheostomy, ventilator dependence)</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">(Peritoneal or Hemodialysis for Renal Failure)</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">(Power or Manual for Non-Ambulatory Children)</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">(for Assisted Walking in Non-Mobile Children)</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">(AFOs, KAFOs, HKAFOs for Stability & Mobility)</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-16 bg-stone-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Our step-by-step process to guide your family through the GAPP application — from first meeting to care
              delivery
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8">
                {processSteps.map((step, index) => (
                  <div key={index} className="flex items-start space-x-6">
                    <div className="relative z-10 bg-primary text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg flex-shrink-0 shadow-lg">
                      {step.step}
                    </div>
            ...
            <div className="mt-10 p-5 bg-primary/5 border border-primary/15 rounded-xl text-center">
              <p className="text-slate-700 text-sm leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-slate-800 mb-4">How to Appeal GAPP's Decision</h2>
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                A denial isn't the end of the road. We'll guide you through every step of the appeal process to give
                your child the best chance at approval.
              </p>
            </div>
            ...
            <div className="space-y-6 mb-14">
              {appealSteps.map((step, index) => (
                <div key={index} className="flex items-start space-x-6">
                  <div className="bg-amber-500 text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg flex-shrink-0 shadow-md">
                    {step.step}
                  </div>
            ...
            {/* The Appeal Itself — 3 detailed sub-steps */}
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-slate-800 border-b border-slate-200 pb-4">
                Writing a Strong Appeal
              </h3>

              {/* Step 1 — Appeal Letter */}
              <Card className="bg-white shadow-md border border-slate-100">
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    ...
                    <CardTitle className="text-lg text-slate-800">Step 1 — Write the Appeal Letter</CardTitle>
                  </div>
                </CardHeader>
              ...
              <Card className="bg-amber-50 shadow-md border border-amber-100">
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    ...
                    <CardTitle className="text-lg text-slate-800">Step 3 — Submit Your Appeal</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="space-y-4">
                  <p className="text-slate-600 leading-relaxed">
